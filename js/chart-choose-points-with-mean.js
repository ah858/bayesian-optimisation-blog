function drawChoosePointsWithMean() {
  ...
  const height  = document.getElementById("chart-choose-points-with-mean").offsetWidth / 2
  ...
  const svg = d3.select("#chart-choose-points-with-mean").append("svg").attr("width", width).attr("height", height);
  // ================================================
